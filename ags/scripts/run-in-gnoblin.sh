...
if [ "${INTERACTIVE:-0}" = 1 ]; then
  ...
  GNOME_DEVKIT_EXEC+='KOBEL_PROFILE_ANIM="$KOBEL_PROFILE_ANIM" LD_PRELOAD="$KOBEL_LAYER_PRELOAD" exec gjs -m "$KOBEL_BUNDLE"'
...
export DISP DK OUT AGSDIR BUNDLE TOGGLE LAYER_PRELOAD PREFIX KOBEL_DEMO KOBEL_DRILL KOBEL_TEST_NOTIFD KOBEL_QUERY KOBEL_DUMP KOBEL_DUMP_OUT KOBEL_PROFILE_ANIM
