...
if [ "${INTERACTIVE:-0}" = 1 ]; then
  ...
  export KOBEL_TOGGLE_REPEATS="${KOBEL_TOGGLE_REPEATS:-1}"
  export KOBEL_TOGGLE_GAP="${KOBEL_TOGGLE_GAP:-3}"
  ...
  GNOME_DEVKIT_EXEC+='KOBEL_TOGGLE_REPEATS="$KOBEL_TOGGLE_REPEATS" '
  GNOME_DEVKIT_EXEC+='KOBEL_TOGGLE_GAP="$KOBEL_TOGGLE_GAP" '
...
export KOBEL_DEMO KOBEL_DRILL KOBEL_TEST_NOTIFD KOBEL_QUERY
export KOBEL_DUMP KOBEL_DUMP_OUT KOBEL_PROFILE_ANIM
export KOBEL_TOGGLE_REPEATS KOBEL_TOGGLE_GAP
