  ...
  return <box name={name} orientation={Gtk.Orientation.VERTICAL} spacing={0}>
    ...
    <box class="qs-top" spacing={0}>
      ...
      <box class="meta" spacing={6} valign={Gtk.Align.CENTER}>
        ...
        <label class="tn" label="100% · Fully charged" />
      </box>
      <box hexpand />
    ...
    <box class="chip-grid" orientation={Gtk.Orientation.VERTICAL} spacing={8}>
      <box class="chips" homogeneous spacing={8}>
        {(DEMO || net.wifi) && <Chip id="wifi" label="Wi-Fi" icon="kobel-wifi-symbolic"
          ...
          onToggled={() => { if (net.wifi) net.wifi.enabled = !net.wifi.enabled }}
...
function MixRow(props: { icon: string, title: string, target: any }) {
  return <box class="mixrow" spacing={10}>
    ...
    <label class="mname" valign={Gtk.Align.CENTER} halign={Gtk.Align.START}
      ellipsize={3} label={props.title} />
    <slider class="slider" hexpand valign={Gtk.Align.CENTER}
