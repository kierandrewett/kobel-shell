...
export default function OSD(monitor: Gdk.Monitor) {
  ...
  return <window
    name="osd" namespace="kobel-osd" gdkmonitor={monitor}
    anchor={Astal.WindowAnchor.BOTTOM} marginBottom={70}
    clickThrough visible={bind(visible)}>
    <box class="osd" spacing={11} widthRequest={230}>
      ...
      <label class="tn" label={bind(speaker, "volume").as(v =>
        `${Math.round(v * 100)}%`)} />
    </box>
  </window>
}
