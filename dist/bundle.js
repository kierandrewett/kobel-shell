...
function Drawer() {
  ...
  return /* @__PURE__ */ jsx2(
    "window",
    {
      ...
      keymode: Astal6.Keymode.ON_DEMAND,
      setup: (self) => self.connect("notify::visible", () => drawerOpen.set(self.visible)),
