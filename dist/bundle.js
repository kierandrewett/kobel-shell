...
var ctors_gtk4 = {
  box: Box, button: Button, centerbox: CenterBox, entry: Entry, image: Image,
  label: Label, levelbar: LevelBar, menubutton: MenuButton, overlay: Overlay,
  revealer: Revealer, slider: Slider, stack: Stack, switch: Switch,
  window: Window, popover: Popover,
};
function jsx2(ctor, props) { return jsx(ctors_gtk4, ctor, props); }
var jsxs = jsx2;
